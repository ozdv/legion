    ...
    <HeadlessTransition appear as={Fragment} show={open} {...props}>
      <HeadlessDialog onClose={onClose}>
        <HeadlessTransitionChild
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 top-0 z-10 flex w-screen justify-center overflow-y-auto bg-zinc-950/25 px-2 py-2 backdrop-blur backdrop-filter focus:outline-0 dark:bg-zinc-950/50 sm:px-6 sm:py-8 lg:px-8 lg:py-16" />
          {/* <div className="fixed inset-0 flex w-screen justify-center overflow-y-auto bg-zinc-950/25 px-2 py-2 focus:outline-0 dark:bg-zinc-950/50 sm:px-6 sm:py-8 lg:px-8 lg:py-16" />  // remove ^*/}
        </HeadlessTransitionChild>

        <HeadlessTransitionChild
          className="fixed inset-0 z-10 w-screen overflow-y-auto pt-6 sm:pt-0"
          // className="fixed inset-0 w-screen overflow-y-auto pt-6 sm:pt-0" // remove ^
          enter="ease-out duration-100"
